...
import Supply_top from '../Supply_top'
import Card from './../card';
import Supplier_form from '../Suuplier_Form/Supplier_form';

export default class Supplier_dashboard extends Component {
...
handlecancel = () => {
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                 ...
                 {this.state.showform ? <Supplier_form></Supplier_form> : <div className="row row-class">
                    <Card></Card>
                    <Card></Card>
                    <Card></Card>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white" class="bi bi-plus" viewBox="0 0 16 16">
