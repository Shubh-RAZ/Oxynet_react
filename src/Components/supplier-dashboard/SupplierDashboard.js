                            ...
                            <div className="supplier-form-whole" style={{margin: 'auto'}}>
                                <div className="form-inside">
                                    ...
                                    <div className="input-field">
                                        <input defaultValue={this.props.quantity} type="text" className="in-input" placeholder="Quantity (eg. 100 Oxygen Cylinders)" required></input>
                                    </div>
                                    <div style={{height:'30px'}}></div>
                                    <div className="input-field">
                                        <input defaultValue={this.props.cost} type="text" className="in-input" placeholder="Cost (MRP) per cylinder" required></input>
                                    </div>
                                    <div style={{height:'30px'}}></div>
                                    <div className="input-field">
                                        <input defaultValue={this.props.phone1} type="text" className="in-input" placeholder="10 digit Phone Number" required></input>
                                    </div>
                                    <div style={{height:'30px'}}></div>
                                    <div className="input-field">
                                    ...
                                    <div style={{height:'30px'}}></div>
                                    <div className="input-field">
                                        <input defaultValue={this.props.shopname} type="text" className="in-input" placeholder="Shop Name" required></input>
                                    </div>
                                    <div style={{height:'30px'}}></div>
                                    <div className="input-field">
                                        <input defaultValue={this.props.shopadd} type="text" className="in-input" placeholder="Shop Address" required></input>
                                    </div>
                                    <div style={{height:'30px'}}></div>
                                    <div className="input-field" >
                                        <select className="in-input" name="stateName" id="state" defaultValue={this.props.state} onChange={this.myChangeHandler} required>
...
//     render() {
//         console.log('Show form '+this.state.showform)
//         return (
...
//                     {this.state.showform ? <SupplierForm></SupplierForm> : 
//                         <div className="row row-class">
//                             {this.state.render.map((obj,index)=>{return (
//                                                                             <div className="col-md-3 cards" style={{width: '100%',padding:'15px 0'}} >
//                                                                                 <div className="card-inside">
...
//                                                                                     </div>
//                                                                                     <div className="service">
//                                                                                         <button type="button" className="report-btn" onClick={this.handledelete} style={{width:'80px'}}>Delete</button>
//                                                                                         <div style={{width:'50px'}}></div>
//                                                                                         <button type="button" className="report-btn" onClick={this.handleform} style={{width:'80px',background:'green'}}>Edit</button>
//                                                                                     </div>
//                                                                                     <font>
